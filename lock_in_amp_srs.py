...
“V” Volts"""
    def __init__(self, instrument, name, save_files_path=None):
        super().__init__(instrument, EInstrument.LOCK_IN_AMP, save_files_path)
...
class Reference:
    ...
    def __init__(self, instrument, data_handler):
        ...
        self.time_base = TimeBase(instrument, data_handler)
        self.phase = Phase(instrument, data_handler)
        self.frequency = Frequency(instrument, data_handler)
        self.harmonics = Harmonics(instrument, data_handler)
        self.sr540 = SR540(instrument, data_handler)
        self.sine = Sine(instrument, data_handler)
        self.source = Source(instrument, data_handler)
        self.trigger = Trigger(instrument, data_handler)
...
class Signal:
    ...
    def __init__(self, instrument, data_handler):
        self.instrument = instrument
        self.data_handler = data_handler
        self.voltage = Voltage(instrument, data_handler)
        self.current = Current(instrument, data_handler)
        self.filter = Filter(instrument, data_handler)
...
class Channel:
    ...
    def __init__(self, instrument, data_handler, channel):
        ...
        self.offsets = Offsets(instrument, data_handler, channel)
    ...
    def get_ratio_mode(self, channel):
        ...
        return int(response)
class Offsets:
    """Commands to control the output offset settings of the lock-in amplifier."""
    def __init__(self, instrument, data_handler, channel):
        self.instrument = instrument
        self.data_handler = data_handler
        self.channel = channel
...
class Display:
    ...
    def __init__(self, instrument, data_handler):
        self.instrument = instrument
        self.data_handler = data_handler
        self.channel_1 = Display_Channel(instrument, data_handler, 1)
        self.channel_2 = Display_Channel(instrument, data_handler, 2)
        self.channel_3 = Display_Channel(instrument, data_handler, 3)
        self.channel_4 = Display_Channel(instrument, data_handler, 4)
        self.cursor = Cursor(instrument, data_handler)
        self.fft = FFT(instrument, data_handler)
...
class Data:
    ...
    def __init__(self, instrument, data_handler):
        self.instrument = instrument
        self.data_handler = data_handler
        self.transfer = Transfer(instrument, data_handler)
        self.capture = Capture(instrument, data_handler)
        self.ethernet_streaming = Ethernet_Streaming(instrument, data_handler)
