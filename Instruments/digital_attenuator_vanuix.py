...
class DigitalAttenuator(Instrument):
    """Class to control Vanuix Digital Attenuators via their DLL API."""
    ...
    def enable_testing(self):
        """Enables testing mode for the digital attenuator."""
    ...
    def set_working_frequency(self, frequency_mhz):
        ...
        :param frequency_mhz: Frequency in MHz (e.g., 1500 for 1.5 GHz)
        :type frequency_mhz: float
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_attenuation(self, attenuation_db):
        ...
        :param attenuation_db: Desired attenuation in dB (e.g., 10 for 10 dB)
    ...
    def set_attenuation_hr(self, attenuation_db):
        ...
        :param attenuation_db: Desired attenuation in dB (e.g., 5 for 5 dB)
        :type attenuation_db: float
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_attenuation_step(self, step_db):
        ...
        :param step_db: Step size in dB (e.g., 2 for 2 dB)
        :type step_db: float
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_first_dwell_time(self, dwell_time_ms):
        ...
        :param dwell_time_ms: Dwell time in milliseconds (minimum 1 ms)
        :type dwell_time_ms: float
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_idle_time(self, idle_time_ms):
        ...
        :param idle_time_ms: Idle time in milliseconds (minimum 0 ms)
        :type idle_time_ms: float
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_hold_time(self, hold_time_ms):
        ...
        :param hold_time_ms: Hold time in milliseconds (minimum 0 ms)
        :type hold_time_ms: float
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_profile_element(self, index, attenuation_db):
        ...
        :param index: Index of the profile element (0 to PROFILE_MAX-1)
        :type index: int
        :param attenuation_db: Desired attenuation in dB
        :type attenuation_db: float
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_profile_count(self, profile_count):
        ...
        :param profile_count: Number of elements (1 to PROFILE_MAX-1)
    ...
    def start_profile(self, mode):
        ...
        :param mode: 1 = play once, 2 = play repeatedly
        :type mode: int
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_rf_on(self, on):
        ...
        :param on: Boolean value indicating whether to turn RF on (True) or off (False).
        :type on: bool
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_ramp_direction(self, up):
        ...
        :param up: True for increasing attenuation, False for decreasing.
        :type up: bool
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_ramp_mode(self, repeat):
        ...
        :param repeat: True for repeated ramp, False for single ramp.
        :type repeat: bool
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def set_ramp_bidirectional(self, bidir_enable):
        ...
        :param bidir_enable: True to enable, False to disable.
        :type bidir_enable: bool
        :return: Status code from the DLL function call.
        :rtype: int
        """
    ...
    def get_working_frequency(self):
        ...
        :return: Working frequency in MHz.
        :rtype: float
        """
    ...
    def get_min_working_frequency(self):
        ...
        :return: Minimum working frequency in MHz.
        :rtype: float
        """
    ...
    def get_max_working_frequency(self):
        ...
        :return: Maximum working frequency in MHz.
        :rtype: float
        """
    ...
    def get_min_attenuation_step(self):
        ...
        :return: Minimum attenuation step size in dB
        :rtype: float
        """
    ...
    def get_max_attenuation_step_hr(self):
        ...
        :return: Maximum attenuation step size in dB
        :rtype: float
        """
