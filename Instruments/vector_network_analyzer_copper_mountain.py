...
trace data transfer.
        ...
        class TraceAnalysis:
            ...
            def __init__(self, instrument, data_handler,channel):
                ...
                self.data_handler = data_handler
                self.n = channel
                self.trace_hold = self.TraceHold(self.instrument)
        ...
        class MST:
            """
            Statistic math statistics commands.
            """
            def __init__(self, instrument, data_handler, channel):
                self.instrument = instrument
                self.data_handler = data_handler
...
frequency offset, channel data transfer."""
        ...
        class ReferenceSource:
            """
            Analyzer reference source commands.
            """
            def __init__(self, instrument, data_handler, channel):
                self.instrument = instrument
                self.data_handler = data_handler
        ...
        class Voltage:
            ...
            class AverageState:
                """
                Averaging function ON/OFF commands.
                """
                def __init__(self, instrument, data_handler, channel):
                    self.instrument = instrument
                    self.data_handler = data_handler
        ...
        class Adapter:
            ...
            class RemovalInsertion:
                """
                Adapter removal/insertion function commands.
                """
                def __init__(self, instrument, data_handler, channel):
                    self.instrument = instrument
                    self.data_handler = data_handler
        ...
        class Correction:
            ...
            class CollectSubClass:
                """
                Calibration standard subclass selection for calibration collection.
                """
                def __init__(self, instrument, data_handler, channel):
                    self.instrument = instrument
                    self.data_handler = data_handler
                ...
                def get_subclass(self) -> int:
                    ...
                    """
                    return int(self.instrument.query(f":SENS{self.n}:CORR:COLL:SUBC?"))
            class CollectMethodSOLT3:
                """
                Calibration collection method commands for SOLT3 and SOLT4.
                """
                def __init__(self, instrument, data_handler, channel):
                    self.instrument = instrument
                    self.data_handler = data_handler
                ...
                def set_trl2(self, port1: int, port2: int):
                    """
                    Selects the ports and sets the two-port TRL calibration type for the calculation of the calibration coefficients.
            ...
            class CollectSimplifiedSave:
                """
                Simplified calibration collection save commands.
                """
                def __init__(self, instrument, data_handler, channel):
                    self.instrument = instrument
                    self.data_handler = data_handler
            ...
            class ThruAddition:
                """
                Thru addition calibration commands.
                """
                def __init__(self, instrument, data_handler, channel):
                    self.instrument = instrument
                    self.data_handler = data_handler
                ...
                def get_thru_addition_delay(self) -> float:
                    """
                ...
                def set_thru_addition_length(self, value: float):
                    """
                ...
                def get_thru_addition_length(self) -> float:
                    """
                ...
                def set_thru_addition_unit(self, unit: str):
                    """
                ...
                def get_thru_addition_unit(self) -> str:
                    """
                ...
                def set_thru_addition_media(self, media: str):
                    """
                ...
                def get_thru_addition_media(self) -> str:
                    """
                ...
                def set_thru_addition_permittivity(self, value: float):
                    """
                ...
                def get_thru_addition_permittivity(self) -> float:
                    """
            ...
            class Trigger:
                """
                Calibration trigger source functions.
                """
                def __init__(self, instrument, data_handler, channel):
                    self.instrument = instrument
                    self.data_handler = data_handler
            ...
            class Type:
                """
                Calibration type and port info for trace.
                """
                def __init__(self, instrument, data_handler, channel):
                    self.instrument = instrument
                    self.data_handler = data_handler
    ...
    class Status:
        ...
        class Questionable:
            ...
            class Limit:
                """
                Questionable Limit status register commands.
                """
                def __init__(self, instrument):
                    self.instrument = instrument
            ...
            class RippleLimit:
                """
                Questionable Ripple Limit status register commands.
                """
                def __init__(self, instrument):
                    self.instrument = instrument
    ...
    class System:
        ...
        class Correction:
            ...
            def set_correction_state(self, enable: bool):
                """
